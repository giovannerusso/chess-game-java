...
public class King extends ChessPiece {
    ...
    public boolean[][] possibleMoves() {
        ...
        if (getMoveCount() == 0 && !chessMatch.getCheck()) {
            ...
            Position posT1 = new Position(position.getRow(), position.getColumn() + 3); //Posição onde a Torre deve estar
            ...
            Position posT2 = new Position(position.getRow(), position.getColumn() - 4); //Posição onde a Torre deve estar
